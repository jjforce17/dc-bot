...
module.exports = {
        ...
        async execute(client, message, args, Discord, profileData) {
            ...
            const cardu1 = args[1];
            const cardu2 = args[2];
            var win1amt = Math.floor(parseInt(amount) * 0.2);
            var win2amt = Math.floor(parseInt(amount) * 0.5);
            ...
            if (cardu1 <= 0 && cardu1 >=14) return message.channel.send("Value of cards must be between 1 and 13");
            if (cardu2 <= 0 && cardu2 >=14) return message.channel.send("Value of cards must be between 1 and 13");
            try {
